...
console.log(`Element removed: ${removedItemPop}`);
console.log(cargoHold);

//3) Remove the first item from the array with shift. Print the element removed and the updated array.
const removedItemShift = cargoHold.shift();
console.log(`Element removed (shift): ${removedItemShift}`);
console.log(cargoHold);
...
console.log(
  `Final array: [${cargoHold.join(", ")}], Length: ${cargoHold.length}`
);
